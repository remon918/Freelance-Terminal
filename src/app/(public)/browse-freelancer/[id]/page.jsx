    ...
    <div className="max-w-6xl mx-auto px-4 md:px-6 mt-9 font-sans text-inherit space-y-6">
      ...
      <form onSubmit={handleFilterSubmit} className="grid grid-cols-1 sm:grid-cols-3 gap-4 bg-current/5 p-4 rounded-xl border border-current/10">
        ...
        <div className="relative flex items-center">
          <Search className="absolute left-3 w-4 h-4 text-neutral-400 z-10" />
          <input
            type="text"
            placeholder="Search name, title, or skills..."
            value={search}
            onChange={(e) => setSearch(e.target.value)}
            className="w-full pl-9 pr-4 py-2 bg-zinc-900 border border-current/10 rounded-lg text-sm text-white placeholder-neutral-400 focus:outline-none focus:border-cyan-500 transition"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-full px-3 py-2 bg-zinc-900 border border-current/10 rounded-lg text-sm text-white placeholder-neutral-400 focus:outline-none focus:border-cyan-500 transition"
          />
